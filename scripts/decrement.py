...
os.mkdir(minified_datasets_folder)
os.mkdir(os.path.join(minified_datasets_folder, "dataset_thumbs"))
shutil.copyfile(
...
for dataset_name in datasets.keys():
    ...
    minified_dataset_folder = os.path.join(minified_datasets_folder, dataset_name)
    ...
    # Copy thumbnail folder
    shutil.copyfile(
            os.path.join(datasets_folder, "dataset_thumbs", dataset_name + ".png"),
            os.path.join(minified_datasets_folder, "dataset_thumbs", dataset_name + ".png")
            )
    ...
    with open(os.path.join(minified_dataset_folder, "items.json"), 'w') as items:
